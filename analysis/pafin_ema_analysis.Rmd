...
# helper function with optional emotion descriptions
gg_emotion_act <- function(emotion_levels, emotion_labels, emotion_descriptions = TRUE) {
  ...
  if (emotion_descriptions) {
    ...
    # Split descriptions into left and right
    left_descriptions <- c(
      "None at all", 
      "Very inactive/quiet",
      "Very tired/sluggish",
    ...
    var_descriptions <- data.frame(
      ...
      left_desc = left_descriptions,
      right_desc = right_descriptions,
      y_pos = y_positions
    )
    ...
    plot_elements <- c(
      ...
      list(
        ...
        geom_text(
          ...
          aes(x = 0.1, y = y_pos, label = left_desc),
          inherit.aes = FALSE,
          size = 4.5,
        ...
        geom_text(
          data = var_descriptions,
          aes(x = 0.9, y = y_pos, label = right_desc),
          inherit.aes = FALSE,
          size = 4.5,
...
plot_all <- ema_data %>%
  ...
  gg_emotion_act(emotion_levels, emotion_labels, emotion_descriptions = TRUE) +
  labs(x = "Response") 
plot_all
