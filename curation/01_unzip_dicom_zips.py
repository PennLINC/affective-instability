...
if __name__ == "__main__":
    status_file = "/cbica/projects/pafin/sourcedata/curation_files/01_status_unzip_dicom_zips.txt"
    ...
    zip_files = sorted(glob("/cbica/projects/pafin/sourcedata/imaging/*.zip"))
